  ...
  return (
    <Container component="main" maxWidth="md">
      ...
      <Box mt={3}>
        <h4>Features</h4>
        <div>
          <b>Query</b>: Search Lorem Picsum images by tags or by 1 URL in the text bar
        </div>
        <div>
          <b>Surprise Me</b>: Search for images with tags generated by Picsum Vision
        </div>
        <div>
      ...
      <Box mt={3}>
        ...
        <div>
          <b>Surprise Me</b> Pick a random image, branch out to its tags, and perform a 1-step graph traversal for each
        </div>
        <div>
        ...
        <div>
          <b>Interact</b>: Perform 1-step graph traversal for associated tags, and 2-step graph traversal for similar images
        </div>
        <div>
