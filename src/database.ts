...
export const documentCollections: string[] = ['Image', 'Author', 'Label', 'BestGuess', 'Object', 'Landmark'];
export const edgeCollections: string[] = ['LabelOf', 'AuthorOf', 'BestGuessOf', 'ObjectOf', 'LandmarkOf'];
